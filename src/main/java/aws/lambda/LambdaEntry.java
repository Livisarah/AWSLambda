...
public class LambdaEntry {
	...
	private static final String CHROME_HEADLESS_PACKAGE =
			  "https://webdriver-testing-resources.s3.amazonaws.com/stable-headless-chromium-amazonlinux-2017-03.zip";
			  private static final String CHROME_DRIVER =
			  "https://webdriver-testing-resources.s3.amazonaws.com/chromedriver_linux64.zip";
